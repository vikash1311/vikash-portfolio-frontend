  ...
  return (
    <section id="achievements" style={{ padding: '6rem 4rem', maxWidth: 1200, margin: '0 auto' }}>
      <div className="reveal">
        ...
        <p style={{ fontSize: '1rem', color: 'var(--muted,#6B7280)', maxWidth: 560, lineHeight: 1.7, marginBottom: '2.5rem' }}>Published research, government copyright, competitive rankings.</p>
      </div>
